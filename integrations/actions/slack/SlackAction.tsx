...
export default function SlackAction({id,option}) {
  ...
  const webhook=localStorage.getItem("slackWebhook")//useSlackStore(state=>state.OAuthCode)
  //const [webhook,setWebhook]=useState("")
   useEffect(()=>{
    ...
    console.log("meow meow",id,aioption)
    if(aioption===option && webhook){
